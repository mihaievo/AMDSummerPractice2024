...
HD_PWD='C:/Users/training/Proiect_D4_CraciunM/Proiect_D4_CraciunM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CBB_D.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CBB_D.tcl -notrace
