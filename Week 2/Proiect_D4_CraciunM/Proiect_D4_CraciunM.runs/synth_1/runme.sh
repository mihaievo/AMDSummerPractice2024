...
HD_PWD='C:/Users/training/Proiect_D4_CraciunM/Proiect_D4_CraciunM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CBB_D.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CBB_D.tcl
