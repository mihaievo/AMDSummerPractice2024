...
HD_PWD='C:/Users/training/Week 2/Proiect_D3_CraciunM/Proiect_D3_CraciunM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_mem.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_mem.tcl
